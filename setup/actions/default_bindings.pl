...
'<< pen leader >>' =>
	...
	'mouse pen emulation toggle direction'        => [ 'C00-Tab',              \&App::Asciio::GTK::Asciio::Pen::toggle_mouse_emulation_move_direction                  ],

	'Mouse pen emulation move left'               => [['000-Left', 'C00-h'],   \&App::Asciio::GTK::Asciio::Pen::pen_mouse_emulation_move_left                          ],
	'Mouse pen emulation move right'              => [['000-Right', 'C00-l'],  \&App::Asciio::GTK::Asciio::Pen::pen_mouse_emulation_move_right                         ],
	'Mouse pen emulation move up'                 => [['000-Up', 'C00-k'],     \&App::Asciio::GTK::Asciio::Pen::pen_mouse_emulation_move_up                            ],
	'Mouse pen emulation move down'               => [['000-Down', 'C00-j'],   \&App::Asciio::GTK::Asciio::Pen::pen_mouse_emulation_move_down                          ],
	'Mouse pen emulation move left quick'         => ['0A0-h',                 \&App::Asciio::GTK::Asciio::Pen::pen_mouse_emulation_move_left_quick                    ],
	'Mouse pen emulation move right quick'        => ['0A0-l',                 \&App::Asciio::GTK::Asciio::Pen::pen_mouse_emulation_move_right_quick                   ],
	'Mouse pen emulation move up quick'           => ['0A0-k',                 \&App::Asciio::GTK::Asciio::Pen::pen_mouse_emulation_move_up_quick                      ],
	'Mouse pen emulation move down quick'         => ['0A0-j',                 \&App::Asciio::GTK::Asciio::Pen::pen_mouse_emulation_move_down_quick                    ],
	'Mouse pen emulation move space'              => ['000-space',             \&App::Asciio::GTK::Asciio::Pen::pen_mouse_emulation_move_space                         ],
	'Mouse pen emulation move left tab'           => ['00S-ISO_Left_Tab',      \&App::Asciio::GTK::Asciio::Pen::pen_mouse_emulation_move_left_tab                      ],
	'Mouse pen emulation move right tab'          => ['000-Tab',               \&App::Asciio::GTK::Asciio::Pen::pen_mouse_emulation_move_right_tab                     ],
	'Mouse pen emulation enter'                   => ['00S-Return',            \&App::Asciio::GTK::Asciio::Pen::mouse_emulation_press_enter_key                        ],
	'Mouse pen emulation delete dot'              => ['000-Delete',            \&App::Asciio::GTK::Asciio::Pen::pen_delete_element, 1                                  ],
	'Mouse pen emulation back delete dot'         => ['000-BackSpace',         \&App::Asciio::GTK::Asciio::Pen::pen_back_delete_element, 1                             ],
	'Mouse pen emulation switch chars next'       => ['C00-Return',      \&App::Asciio::GTK::Asciio::Pen::pen_switch_next_character_sets, 1                      ],
	'Mouse pen emulation change help '            => ['C0S-Return',            \&App::Asciio::GTK::Asciio::Pen::pen_switch_show_mapping_help_location,                 ],
	'Mouse pen emulation switch chars previous'   => ['0A0-Return',            \&App::Asciio::GTK::Asciio::Pen::pen_switch_previous_character_sets, 1                  ],

	# :QQ: These character insertion operations are filtered out and the key completion prompt
